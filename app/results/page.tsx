  ...
  if (!mounted) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <p className="text-muted-foreground">Loading Results Dashboard...</p>
      </div>
    );
  }
      ...
      <main className="py-16 md:py-24">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            {overallStats.map((s) => (
              ...
              >
                ...
                <p className="text-2xl md:text-3xl font-sans font-semibold text-foreground mb-1">
                  {s.value}
                </p>
        ...
        <div className="container-main mb-20">
          <div className="text-center mb-8">
            <h3 className="text-xl md:text-2xl font-sans font-semibold text-foreground">Channel ROI Performance Dashboard</h3>
        ...
        <div className="container-main grid gap-8 max-w-4xl mx-auto">
          <div className="border-b border-border/40 pb-4 mb-2">
            <h3 className="text-2xl font-sans font-semibold text-foreground">Detailed Performance Records</h3>
          </div>
            ...
            return (
              ...
              >
                <div className="flex flex-wrap items-center gap-3.5 border-b border-border/20 pb-4">
                  ...
                  <div>
                    <h2 className="text-lg font-sans font-semibold text-foreground leading-tight">{c.client}</h2>
                    ...
                    {c.results.map((r) => (
                      <div key={r.metric} className="bg-background/80 border border-border/60 p-4 rounded-xl text-center hover:border-primary/30 transition-all">
                        ...
                        <div className="flex items-baseline justify-center gap-2 mt-1">
                          <p className="text-xl font-sans font-semibold text-primary">{r.after}</p>
                          {r.before && r.before !== "—" && (
        ...
        <div className="container-main mt-24">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-5xl font-sans font-medium tracking-tight text-foreground leading-tight mb-4">
