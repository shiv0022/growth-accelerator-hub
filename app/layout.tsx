...
export const metadata: Metadata = {
  ...
  icons: {
    apple: [{ url: "/logo-rx.png", sizes: "180x180", type: "image/png" }],
    icon: [
      { url: "/logo-rx.png", sizes: "32x32", type: "image/png" },
      { url: "/logo-rx.png", sizes: "16x16", type: "image/png" },
      { url: "/logo-rx.png", rel: "shortcut icon", type: "image/png" },
    ],
  },
